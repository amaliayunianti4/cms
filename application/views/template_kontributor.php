			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				<div class="app-brand demo">
					<a href="<?= base_url();?>" class="app-brand-link">
						...
						<span class="app-brand-text demo menu-text fw-bolder ms-2">CMS Duor🤩</span>
					</a>
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item <?php if($menu== 'home'){ echo "active"; } ?> ">
						<a href="<?= site_url('kontributor/home') ?>" class="menu-link">
					...
					<li class="menu-item <?php if($menu== 'konten'){ echo "active"; } ?>">
						<a href="<?= site_url('kontributor/konten')?>" class="menu-link">
					...
					<!-- Misc -->
					<li class="menu-item">
						<a href="https://github.com/themeselection/sneat-html-kontributor-template-free/issues"
							target="_blank" class="menu-link">
						</a>
					</li>
					<li class="menu-item">
						<a href="https://themeselection.com/demo/sneat-bootstrap-html-kontributor-template/documentation/"
							target="_blank" class="menu-link">
						</a>
					</li>
				</ul>
							...
							<li class="nav-item navbar-dropdown dropdown-user dropdown">
								<a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
									...
									<div class="avatar avatar-online">
										<img src="<?= site_url('assets/sneat/') ?>/assets/img/miror.jpeg" alt
										...
										<a class="dropdown-item" href="#">
											<div class="d-flex">
												<div class="flex-shrink-0 me-3">
													<div class="avatar avatar-online">
														<img src="<?= site_url('assets/sneat/') ?>/assets/img/miror.jpeg"
												...
												<div class="flex-grow-1">
													...
													<small
														class="text-muted"><?=$this->session->userdata('level')?></small>
												</div>
											</div>
										</a>
									</li>
						...
						<div
							...
							<div class="mb-2 mb-md-0">
								...
								<a href="https://themeselection.com" target="_blank"
									class="footer-link fw-bolder">amall</a>
							</div>
